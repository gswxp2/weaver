...
mha_fwd_kvcache(at::Tensor &q,                 // batch_size x seqlen_q x num_heads x head_size
                ...
                const c10::optional<at::Tensor> &check_meta, // batch_size x seqlen_knew x num_heads_k x head_size
    ...
    params.check_meta_ptr = check_meta.has_value() ? check_meta.value().data_ptr() : nullptr;
...
TORCH_LIBRARY_EXPAND(TORCH_EXTENSION_NAME, ops) {
    ...
    ops.def("fwd_kvcache(Tensor! q, Tensor kcache, Tensor vcache, Tensor? k, Tensor? v,Tensor? check_meta, Tensor? seqlens_k, "
