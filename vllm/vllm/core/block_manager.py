...
class SelfAttnBlockSpaceManager(BlockSpaceManager):
    ...
    def __init__(
        ...
        global BLOCK_ALLOCATOR_INSTANCE
        BLOCK_ALLOCATOR_INSTANCE = self.block_allocator._allocators[Device.GPU]

    def get_instance():
        global BLOCK_ALLOCATOR_INSTANCE
        return BLOCK_ALLOCATOR_INSTANCE
